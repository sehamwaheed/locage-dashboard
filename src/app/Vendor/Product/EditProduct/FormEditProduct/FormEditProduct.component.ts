...
export class FormEditProductComponent implements OnInit {
  ...
  // this.max = moment().add(1, 'months').endOf('month').toDate();
    ...
    this.formEdit=this.fb.group({
      _id: [''],
      title:this.fb.control('',[Validators.required,Validators.minLength(3), Validators.maxLength(60)]),
      description:this.fb.control('',[Validators.required , Validators.minLength(50), Validators.maxLength(200)]),
      ...
      Weight:this.fb.control('',[Validators.required,Validators.min(10),Validators.max(1000000)]),
